...
<p align="center"><a href="./README.md">简体中文</a> | <a href="./README.en.md">English</a> | <a href="./README.ja.md">日本語</a> | <strong>한국어</strong></p>
...
계획은 본인 브라우저에만 저장됩니다. 업로드되지 않으며 다른 기기로 따라가지 않습니다 — 옮기려면 '내보내기'를 쓰세요.
...
- 점수는 브라우저에서 계산됩니다. 서버로 전송되지 않고 계정에도 저장되지 않습니다
...
이 README는 제품 사용자를 위한 문서입니다. 프로젝트 작업은 [architecture](docs/ARCHITECTURE.md), [deployment](docs/DEPLOYMENT.md), [crawling](docs/CRAWLING.md), [roadmap](docs/ROADMAP-STATUS.md), [contribution rules](AGENTS.md), [changelog](CHANGELOG.md)를 참고하세요.
